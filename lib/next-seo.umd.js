(function (global, factory) {
  ...
  var _excluded$q = ['type', 'keyOverride', 'scriptKey', 'scriptId'];
  ...
  var _excluded$p = ['reviewRating', 'author', 'publisher'];
  ...
  var _excluded$o = ['thumbnailUrls', 'hasPart', 'watchCount', 'publication'];
        ...
        case 'recipe':
          return data.map(function (_ref2, index) {
            var authorName = _ref2.authorName,
              ...
              rest = _objectWithoutPropertiesLoose(_ref2, _excluded$n);
  ...
  var HiringOrganizationType;

  (function (HiringOrganizationType) {
    HiringOrganizationType['confidential'] = 'confidential';
  })(HiringOrganizationType || (HiringOrganizationType = {}));
  ...
  var _excluded$j = ['type', 'keyOverride', 'mainEntity'],
  ...
  var _excluded$i = ['type', 'keyOverride', 'breadcrumb'];
  ...
  var _excluded$h = ['type', 'keyOverride', 'potentialActions'];
  ...
  var _excluded$d = ['type', 'keyOverride', 'contactPoint'];
  ...
  var _excluded$c = ['type', 'keyOverride', 'hasPart'];
  ...
  var _excluded$7 = ['type', 'keyOverride', 'address', 'contactPoints'];
  ...
  var _excluded$6 = ['type', 'keyOverride', 'mainEntity'];
  ...
  var _excluded$5 = ['type', 'keyOverride'];
  ...
  var _excluded$3 = ['type', 'keyOverride', 'courseName', 'provider'];
  ...
  var _excluded$2 = ['type', 'id', 'keyOverride', 'aggregateRating'];
  ...
  var _excluded$1 = ['keyOverride', 'reviewedBy'];
  ...
  var _excluded = ['type', 'keyOverride'];
