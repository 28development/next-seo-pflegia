...
const _excluded$q = ['type', 'keyOverride', 'scriptKey', 'scriptId'];
...
const _excluded$p = ['reviewRating', 'author', 'publisher'];
...
const _excluded$o = ['thumbnailUrls', 'hasPart', 'watchCount', 'publication'];
...
const _excluded$i = ['type', 'keyOverride', 'breadcrumb'];
...
const _excluded$h = ['type', 'keyOverride', 'potentialActions'];
...
const _excluded$d = ['type', 'keyOverride', 'contactPoint'];
...
const _excluded$7 = ['type', 'keyOverride', 'address', 'contactPoints'];
...
const _excluded$6 = ['type', 'keyOverride', 'mainEntity'];
...
const _excluded$5 = ['type', 'keyOverride'];
...
const _excluded$3 = ['type', 'keyOverride', 'courseName', 'provider'];
...
const _excluded$2 = ['type', 'id', 'keyOverride', 'aggregateRating'];
...
const _excluded$1 = ['keyOverride', 'reviewedBy'];
...
const _excluded = ['type', 'keyOverride'];
